...
public class DES {
    // COSTANTI
    // tavola di permutazione iniziale
   private final
    int[] IP = { 58, 50, 42, 34, 26, 18, 10,
                2, 60, 52, 44, 36, 28, 20,
                12, 4, 62, 54, 46, 38,
                30, 22, 14, 6, 64, 56,
                48, 40, 32, 24, 16, 8,
    ...
    // tavola di permutazione inversa
    private final
    ...
    // tavola per permutazione chiave primaria
    private final
    ...
    // tavola per permutazione chiave secondaria
    private final
    ...
    // tavola di permutazione diretta
    private final
    ...
    // permutazione input secondo specifica sequenza
    ...
    // XOR di 2 stringhe esadecimali
    String xor(String a, String b)
    {
        // esadecimale a decimale(base 10)
        long t_a = Long.parseUnsignedLong(a, 16);
        // esadecimale a decimale(base 10)
        long t_b = Long.parseUnsignedLong(b, 16);
        // XOR
        t_a = t_a ^ t_b;
        // decimale ad esadecimale
        a = Long.toHexString(t_a);
        // preappensione di zeri per mantenere lunghezza
        while (a.length() < b.length())
            a = "0" + a;
        return a;
    }

    // shift circolare sinistro
    ...
    // 16 chiavi per 16 round
    String[] getKeys(String key)
    {
        String[] keys = new String[16];
        // prima permutazione della chiave
    ...
    String round(String input, String key, int num)
    {
        ...
        // XOR valore temporaneo e chiave
        temp = xor(temp, key);
        // utilizzo la s-box
        temp = sBox(temp);
        // P-box diretto
    ...
    String encrypt(String plainText, String key)
    {
        ...
        System.out.println(
                "Dopo la permutazione iniziale: "
                        + plainText.toUpperCase());
        System.out.println(
                "Dopo la suddivisione: L0="
