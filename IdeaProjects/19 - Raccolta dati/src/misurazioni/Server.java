...
//    private ConcurrentHashMap<Integer, Misura> mapMisureDataBase = new ConcurrentHashMap<>();   //memorizzo per ogni sensore la misura pi� recente disponibile
//
//    public void run() {
//        new Thread(() -> {
//            try {
...
//
//                    //suppongo che lInitialTimestamp abbia sempre un valore che sia pi� grande del tempo corrente in millisecondi
...
public class Server implements Runnable {
    ...
    private ConcurrentHashMap<Integer, Misura> hmMisure = new ConcurrentHashMap<>();  //memorizzo per ogni sensore la misura pi� recente disponibile
